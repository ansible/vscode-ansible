...
export class CreateDevfile {
            ...
            <form id="devfile-form">
              <section class="component-container">
                ...
                <div class="group-buttons">
                  <vscode-button id="clear-button" form="devfile-form" appearance="secondary">
                ...
                <div class="group-buttons">
                  ...
                  <vscode-button id="open-folder-button" form="devfile-form" disabled>
    ...
    webview.onDidReceiveMessage(
      async (message: any) => {
        ...
        switch (command) {
          ...
          case "open-devfile":
            payload = message.payload;
            await this.openDevfile(payload.projectUrl);
            return;
        }
      },
      undefined,
  ...
  public createDevfile(
    ...
    try {
      ...
      fs.writeFileSync(destinationUrl, devfile);
      return "passed";
    } catch (err) {
