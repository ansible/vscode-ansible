...
import {
  ...
  function main() {
    ...
    devcontainerNameTextField = document.getElementById("devcontainer-name") as TextField;
    ...
    devcontainerLogsTextArea = document.getElementById("log-text-area") as TextArea;
    ...
    devcontainerClearLogsButton.addEventListener("click", handleDevcontainerLogsClick);
