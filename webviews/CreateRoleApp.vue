...
const displayPath = computed(() => {
  return (
    collectionPath.value.trim() || defaultCollectionPath.value || homeDir.value
  );
});
...
const handleCreate = createActionWrapper(
  ...
  () => {
    ...
    const actualCollectionPath =
      collectionPath.value.trim() ||
      defaultCollectionPath.value ||
      homeDir.value;
    const payload = {
      roleName: roleName.value.trim(),
      ...
      <section class="component-container">
        ...
        <div class="checkbox-div">
          ...
          >
            Overwrite <br />
            <i
              >Overwriting will replace an existing role with the same name if
              present in the collection.</i
            >
          </vscode-checkbox>
        </div>
