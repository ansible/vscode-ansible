  ...
  <div id="quickLinksView">
    ...
    <div class="index-list start-container">
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.content-creator.menu"
            title="Ansible Development Tools welcome page"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.mcpServer.enabled"
            title="Activate Ansible Development Tools MCP Server for AI assistants"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="https://docs.redhat.com/en/documentation/red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant/2.x_latest/html-single/red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant_user_guide/index#using-code-bot-for-suggestions_lightspeed-user-guide"
            title="Ansible code bot documentation"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="https://docs.ansible.com/projects/dev-tools/"
            title="Ansible Development Tools documentation"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.extension-settings.open"
            title="Ansible extension settings"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.lightspeed.openLlmProviderSettings"
            title="Configure LLM provider for Ansible Lightspeed"
          >
            <span class="codicon codicon-settings-gear"></span> LLM Provider
            <span
              v-if="activeProviderName && isProviderConnected"
              class="active-provider-badge connected"
            >
              : {{ activeProviderName }}
            </span>
          </a>
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.lightspeed.playbookGeneration"
            title="Generate a playbook with Ansible Lightspeed"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.lightspeed.playbookExplanation"
            title="Explain the current playbook"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.lightspeed.roleGeneration"
            title="Generate a role with Ansible Lightspeed"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.lightspeed.roleExplanation"
            title="Explain the current role"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.content-creator.create-execution-env-file"
            title="Create an execution environment project"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.content-creator.create-ansible-project"
            title="Create a playbook project"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.content-creator.add-plugin"
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.content-creator.create-devcontainer"
            title="Create a devcontainer and add it to an existing Ansible project"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.content-creator.create-devfile"
            title="Create a devfile and add it to an existing Ansible project"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.content-creator.create-role"
            title="Create a role and add it to an existing Ansible collection"
          >
      ...
      <div class="catalogue">
        <h3>
          <a
            href="command:ansible.create-empty-playbook"
            title="Create a playbook template"
          >
