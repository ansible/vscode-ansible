...
async function sendActionEvent(action: WizardGenerationActionType, fromPage: number, toPage: undefined | integer = undefined) {
...
sendActionEvent(WizardGenerationActionType.OPEN, 1);
</script>
