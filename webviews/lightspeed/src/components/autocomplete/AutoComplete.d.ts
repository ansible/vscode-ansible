...
export declare type AutoCompletePassThroughOptionType =
  | AutoCompletePassThroughAttributes
  | ((
      options: AutoCompletePassThroughMethodOptions,
    ) => AutoCompletePassThroughAttributes | string)
  | string
  | null
  | undefined;
 ...
 */
export interface AutoCompleteOptionUnselectEvent
  extends AutoCompleteOptionSelectEvent {}
 ...
 *
 */
declare const AutoComplete: DefineComponent<
  AutoCompleteProps,
  AutoCompleteSlots,
  AutoCompleteEmits
>;
