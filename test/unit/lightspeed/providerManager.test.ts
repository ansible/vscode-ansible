...
describe("ProviderManager", () => {
  ...
  describe("completionRequest", () => {
    it("should route completion request to Google provider", async () => {
      ...
      expect(completionRequest).toHaveBeenCalledWith(params);
  ...
  describe("chatRequest", () => {
    it("should route chat request to Google provider", async () => {
      ...
      expect(chatRequest).toHaveBeenCalledWith(params);
  ...
  describe("generatePlaybook", () => {
    it("should route playbook generation to Google provider", async () => {
      ...
      expect(generatePlaybook).toHaveBeenCalledWith(params);
  ...
  describe("generateRole", () => {
    it("should route role generation to Google provider", async () => {
      ...
      expect(generateRole).toHaveBeenCalledWith(params);
    ...
    it("should route role generation to WCA", async () => {
      ...
      const roleGenerationRequest = vi.mocked(mockWcaApi.roleGenerationRequest);
    ...
    it("should throw error when WCA returns error response", async () => {
      ...
      const roleGenerationRequest = vi.mocked(mockWcaApi.roleGenerationRequest);
      roleGenerationRequest.mockResolvedValue(mockErrorResponse);
      const mockedIsError = vi.mocked(isError);
  ...
  describe("testProviderConnection", () => {
    it("should test WCA connection successfully", async () => {
      const getStatus = vi.mocked(mockWcaApi.getStatus);
      getStatus.mockResolvedValue({
        connected: true,
        modelInfo: {
          name: "WCA",
