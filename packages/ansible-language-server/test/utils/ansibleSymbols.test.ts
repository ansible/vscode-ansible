...
describe("getSymbolAtPosition()", () => {
  describe("handlers", () => {
    ...
    it("should detect notify scalar as handler", () => {
    ...
    it("should detect notify list item as handler", () => {
    ...
    it("should detect handler name as handler definition", () => {
    ...
    it("should detect listen as handler", () => {
  ...
  describe("variables", () => {
    ...
    it("should detect vars key as variable", () => {
    ...
    it("should detect register value as variable", () => {
    ...
    it("should detect Jinja2 variable reference", () => {
    ...
    it("should detect vars_prompt name as variable", () => {
  ...
  describe("file paths", () => {
    ...
    it("should detect include_tasks value as filePath", () => {
    ...
    it("should detect template src as filePath", () => {
    ...
    it("should detect vars_files entry as filePath", () => {
  ...
  describe("roles", () => {
    ...
    it("should detect include_role name as role", () => {
...
describe("findAllOccurrences()", () => {
  describe("handlers", () => {
    ...
    it("should find all handler occurrences", () => {
    ...
    it("should mark handler name as definition", () => {
      const occs = findAllOccurrences(textDoc, "Restart nginx", "handler");
  ...
  describe("variables", () => {
    ...
    it("should find all variable occurrences for http_port", () => {
    ...
    it("should find register definition and Jinja2 usage", () => {
    ...
    it("should find vars_prompt variable", () => {
    ...
    it("should find variable in when condition", () => {
  ...
  describe("modules", () => {
    ...
    it("should find module occurrences", () => {
  ...
  describe("roles", () => {
    ...
    it("should find role occurrences for include_role", () => {
...
describe("findAllOccurrencesInRole()", () => {
  it("should find handler occurrences across role files", () => {
    const roleTasksMain =
      "references/roles/test_role/tasks/main.yml";
    const doc = getDoc(roleTasksMain);
    const result = findAllOccurrencesInRole(
      doc.uri,
      "Restart app",
      "handler",
    );
  ...
  it("should find variable occurrences across role files", () => {
    const roleTasksMain =
      "references/roles/test_role/tasks/main.yml";
    const doc = getDoc(roleTasksMain);
    const result = findAllOccurrencesInRole(
  ...
  it("should return empty map for unsupported kind", () => {
    const doc = getDoc("references/roles/test_role/tasks/main.yml");
    const result = findAllOccurrencesInRole(doc.uri, "test", "filePath");
    expect(result.size).toBe(0);
  });

  it("should return empty map for non-role document", () => {
    const doc = getDoc("references/playbook_handlers.yml");
    const result = findAllOccurrencesInRole(doc.uri, "test", "handler");
    expect(result.size).toBe(0);
  });
});

describe("getSymbolAtPosition() edge cases", () => {
  it("should return null for empty document position", () => {
    const doc = TextDocument.create("file:///tmp/empty.yml", "ansible", 1, "---\n");
    const result = getSymbolAtPosition(doc, Position.create(0, 0));
    expect(result).toBeNull();
  });

  it("should detect module key as module symbol", () => {
    const textDoc = getDoc("references/playbook_handlers.yml");
  ...
  it("should detect copy src as filePath", () => {
    const textDoc = getDoc("references/playbook_includes.yml");
  ...
  it("should return null for position on non-string scalar", () => {
    const content = `---
- hosts: all
  tasks:
    - name: test
...
`;
  ...
  it("should detect import_role name as role", () => {
    const content = `---
- hosts: all
  tasks:
    - name: Import role
...
`;
  ...
  it("should detect simple roles list entry as role", () => {
    const content = `---
- hosts: all
  roles:
    - my_simple_role
`;
  ...
  it("should detect role param in roles section", () => {
    const content = `---
- hosts: all
  roles:
    - role: my_role
...
`;
  ...
  it("should detect variable in when condition", () => {
    const textDoc = getDoc("references/playbook_variables.yml");
...
describe("findAllOccurrences() edge cases", () => {
  it("should return empty for filePath kind", () => {
    const textDoc = getDoc("references/playbook_includes.yml");
    const occs = findAllOccurrences(textDoc, "included_tasks.yml", "filePath");
    expect(occs).toHaveLength(0);
  });

  it("should find role occurrences in roles section with role: key", () => {
    const content = `---
- hosts: all
  roles:
    - role: my_role
...
`;
  ...
  it("should find handler in listen directive", () => {
    const textDoc = getDoc("references/playbook_handlers.yml");
    const occs = findAllOccurrences(textDoc, "Restart nginx", "handler");
  ...
  it("should find Jinja2 variable with filter", () => {
    const content = `---
- hosts: all
  vars:
    my_var: hello
...
`;
  ...
  it("should find variable in changed_when condition", () => {
    const content = `---
- hosts: all
  tasks:
    - name: Run command
...
`;
  ...
  it("should find variable in when list condition", () => {
    const content = `---
- hosts: all
  tasks:
    - name: Test
