...
import { ThumbsUpDownAction } from "../../types";
...
const isDisabled = computed(
  () => selectedFeedback.value !== null || !props.telemetryEnabled,
);
...
<template>
  <div class="stickyFeedbackContainer">
    <div class="feedbackContainer" :class="{ disabled: !telemetryEnabled }">
      ...
      <span v-if="!telemetryEnabled" class="tooltip"
        >Feedback requires telemetry. Enable in Settings:
        redhat.telemetry.enabled</span
      >
    </div>
  </div>
</template>
