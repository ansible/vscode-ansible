...
playKeywords.set('diff', 'Toggle to make tasks return ‘diff’ information or not.');
...
playKeywords.set('module_defaults', 'Specifies default parameter values for modules.');

playKeywords.set('name', 'Identifier. Can be used for documentation, or in tasks/handlers.');
...
playKeywords.set('port', 'Used to override the default port used in a connection.');

playKeywords.set('post_tasks', 'A list of tasks to execute after the tasks section.');

playKeywords.set('pre_tasks', 'A list of tasks to execute before roles.');

playKeywords.set('remote_user', 'User used to log into the target via the connection plugin.');
...
playKeywords.set('strategy', 'Allows you to choose the connection plugin to use for the play.');
...
playKeywords.set('vars_files', 'List of files that contain vars to include in the play.');
...
roleKeywords.set('diff', 'Toggle to make tasks return ‘diff’ information or not.');
...
roleKeywords.set('module_defaults', 'Specifies default parameter values for modules.');

roleKeywords.set('name', 'Identifier. Can be used for documentation, or in tasks/handlers.');

roleKeywords.set('no_log', 'Boolean that controls information disclosure.');

roleKeywords.set('port', 'Used to override the default port used in a connection.');

roleKeywords.set('remote_user', 'User used to log into the target via the connection plugin.');
...
blockKeywords.set('diff', 'Toggle to make tasks return ‘diff’ information or not.');
...
blockKeywords.set('module_defaults', 'Specifies default parameter values for modules.');

blockKeywords.set('name', 'Identifier. Can be used for documentation, or in tasks/handlers.');
...
blockKeywords.set('port', 'Used to override the default port used in a connection.');

blockKeywords.set('remote_user', 'User used to log into the target via the connection plugin.');
...
taskKeywords.set('diff', 'Toggle to make tasks return ‘diff’ information or not.');
...
taskKeywords.set('local_action', 'Same as action but also implies delegate_to: localhost');
...
taskKeywords.set('module_defaults', 'Specifies default parameter values for modules.');

taskKeywords.set('name', 'Identifier. Can be used for documentation, or in tasks/handlers.');
...
taskKeywords.set('poll', 'Sets the polling interval in seconds for async tasks (default 10s).');

taskKeywords.set('port', 'Used to override the default port used in a connection.');
...
taskKeywords.set('remote_user', 'User used to log into the target via the connection plugin.');
